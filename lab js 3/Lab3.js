...
function questlog() {
    ...
    "2. Модифікуйте код таблиці множення, створеної раніше, так, щоб верхній рядок і лівий стовпчик були виведені напівжирним шрифтом, тобто щоб вони сприймалися як заголовки. По контуру таблиця повинна бути червоним кольором, фон - зелений, клітки - жовті.<br \/>" +
